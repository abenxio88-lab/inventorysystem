...
def create_admin_setup_wizard(parent=None) -> bool:
    ...
    verify_window.title("Mintaka Sphere - Admin Verification")
    ...
    wizard_window.title("Mintaka Sphere - Create Administrator Account")
...
def open_owner_dashboard(master=None):
    ...
    win.title("👑 Owner Admin System Control")
